...
export default class HomeScreen extends React.Component { 
    render() { 
        ...
        onPress={() => this.props.navigation.navigate('Web', { sitio: 'casablanca', }) }>
             <Text style={styles.texto}>CASA BLANCA</Text> 
        </TouchableHighlight> 
        <TouchableHighlight style={styles.botones} 
        onPress={() => this.props.navigation.navigate('Web', { sitio: 'joyaceren', })}> 
            <Text style={styles.texto}>JOYA DE CEREN</Text> 
        </TouchableHighlight> 
        <TouchableHighlight style={styles.botones} 
        onPress={() => this.props.navigation.navigate('Web', { sitio: 'sanandres', }) }> 
